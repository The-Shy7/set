 ...
 * Section: CSE 154 AQ
 * This is the JS that implments functionality to my buttons
 * for the set.html page to generate and remove cards from
 * the page, replace them, and adds a timer and score counter.
 */
